                ...
                <div className="hero-content flex-col lg:flex-row">
                    <div className='relative lg:w-1/2'>
                        <motion.img
                            ...
                            className='rounded-tr-[64px] w-full px-4 h-[300px] md:h-[500px]' src={aboutimg1} alt="aboutimg1"
                        />
                        <motion.img
                            initial={{ x: -100, opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            ...
                            className='absolute border-8 rounded-[20px] border-white w-2/5 top-3/4 md:w-2/5 lg:w-2/4 left-[-1] md:top-2/5 lg:top-2/3' src={aboutimg2} alt="aboutimg2"
                        />
                        ...
                        <motion.div
                            ...
                            className='absolute bg-white rounded-xl border-white w-2/4 md:w-2/5 right-0 top-3/4 mt-16 lg:mt-20 lg:top-2/3 p-2 md:p-4 lg:p-2 mt-10'
                        >
                    ...
                    <div className='mt-20 md:mt-40 lg:mt-14 lg:w-1/2'>
                        <motion.h3
                            ...
                            className='text-1xl font-bold text-[#64ab45] bg-[#dde5da] px-4 py-2 w-2/3 rounded'>About Us</motion.h3>
                        <motion.h1
                            initial={{ x: 100, opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            viewport={{ once: true }}
                            ...
                            className="my-8 text-3xl md:text-5xl font-bold">Great opportunity for adventure & travels</motion.h1>
                        <motion.div
                            initial={{ x: 100, opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            viewport={{ once: true }}
                        ...
                        <div className='my-12'>
                            <motion.button
                                ...
                                className="btn bg-[#64ab45] text-white hover:bg-[#82d75d] hover:text-white"
                            >
                                Get More Info</motion.button>
                        </div>
